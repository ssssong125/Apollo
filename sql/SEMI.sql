...
ALTER TABLE TBL_CART ADD CONSTRAINT FK_PRODUCT_NO_CART FOREIGN KEY (PRODUCT_NO) REFERENCES "TBL_PRODUCT"(PRODUCT_NO);
...
ALTER TABLE TBL_PAYMENT ADD CONSTRAINT FK_USER_ID_PAYMENT FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);

ALTER TABLE TBL_BLOG_BOARD ADD CONSTRAINT PK_BLOG_NO PRIMARY KEY (BLOG_NO);
ALTER TABLE TBL_BLOG_BOARD ADD CONSTRAINT FK_USER_ID_BLOG_BOARD FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);

ALTER TABLE TBL_BLOG_IMAGE ADD CONSTRAINT PK_BLOG_IMG_NO PRIMARY KEY (BLOG_IMG_NO);
ALTER TABLE TBL_BLOG_IMAGE ADD CONSTRAINT FK_USER_ID_BLOG_IMAGE FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);
...
ALTER TABLE TBL_PRODUCT_IMAGE ADD CONSTRAINT FK_PRODUCT_NO_PRODUCT_IMAGE FOREIGN KEY (PRODUCT_NO) REFERENCES "TBL_PRODUCT"(PRODUCT_NO);

ALTER TABLE TBL_QUESTION ADD CONSTRAINT PK_QNA_NO PRIMARY KEY (BOARD_NO);
ALTER TABLE TBL_QUESTION ADD CONSTRAINT FK_USER_ID_QUESTION FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);
...
ALTER TABLE TBL_BLOG_COMMENT ADD CONSTRAINT FK_USER_ID_BLOG_COMMENT FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);
ALTER TABLE TBL_BLOG_COMMENT ADD CONSTRAINT FK_BLOG_NO_BLOG_COMMENT FOREIGN KEY (BLOG_NO) REFERENCES "TBL_BLOG_BOARD"(BLOG_NO);

ALTER TABLE TBL_QUESTION_REPLY ADD CONSTRAINT PK_REPLY_NO PRIMARY KEY (REPLY_NO);
ALTER TABLE TBL_QUESTION_REPLY ADD CONSTRAINT FK_USER_ID_QUESTION_REPLY FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);
