...
BEGIN
    UPDATE TBL_USER A
    SET A.USER_POINT = A.USER_POINT - :NEW.USED_POINT + ROUND(:NEW.PAYMENT_AMOUNT * 0.05)
...
BEGIN
    ...
    SET A.PRODUCT_QTY = A.PRODUCT_QTY - :NEW.PRODUCT_COUNT
--                         (SELECT
--                                             B.PRODUCT_COUNT
...
--VALUES(SEQ_PAYMENT_NO.NEXTVAL, 'user01', 1000, 234567, 'kakaoPay', '홍길동', '010-2312-1233', '서울', 220101, '배송 준비중', '문앞에');
...
-- INSERT ALL
-- INTO TBL_ORDER
-- VALUES (SEQ_ORDER_NO.NEXTVAL, SEQ_PAYMENT_NO.CURRTVAL, 1)
-- INTO TBL_ORDER
-- VALUES (SEQ_ORDER_NO.NEXTVAL, SEQ_PAYMENT_NO.CURRTVAL, 2);
