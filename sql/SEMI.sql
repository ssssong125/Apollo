...
ALTER TABLE TBL_CONTACT ADD CONSTRAINT PK_CONTACT_NO PRIMARY KEY (CONTACT_NO);
...
ALTER TABLE TBL_BLOG_IMAGE ADD CONSTRAINT FK_USER_ID_4 FOREIGN KEY (USER_ID) REFERENCES "TBL_USER"(USER_ID);
ALTER TABLE TBL_BLOG_IMAGE ADD CONSTRAINT FK_BLOG_NO_1 FOREIGN KEY (BLOG_NO) REFERENCES "TBL_BLOG_BOARD"(BLOG_NO);
